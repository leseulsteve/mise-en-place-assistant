...
assert.match(panel.shadowRoot.innerHTML, /<h3><span>Top shelf<\/span><span class="content-count">1 container<\/span><\/h3>/);
...
assert.match(panel.shadowRoot.innerHTML, /<h3><span>Door bin<\/span><span class="content-count">1 container<\/span><\/h3>/);
